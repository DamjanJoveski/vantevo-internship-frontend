...
export function Login() {
  ...
  if(userInfo !== undefined){
     userMessage= userInfo.messages.message
     loginStatus = userInfo.messages.loginStatus
  }
          ...
          <div className="w-full rounded-lg shadow border md:mt-0 sm:max-w-md xl:p-0 bg-gray-800 border-gray-700">
            <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              >
                ...
                {loginStatus && loginStatus !== 'Success' && loginStatus !== 'Fail' && (
                    <Loading message={userMessage} />
                )}
                {loginStatus === 'Fail' && (
                 <p className='flex justify-center text-red-600 text-lg'>Login failed! Please try again.</p>
                )}
